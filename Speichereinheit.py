...
map.append(Door("Pictures/Tiles/Door_open_V.png", "Pictures/Tiles/Door_V.png", 6, 12, 1, False))
...
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 11, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 12, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 13, 1))
map.append(Wall("Pictures/Tiles/Wall.png", 7, 14))
map.append(Wall("Pictures/Tiles/Wall.png", 8, 10))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 11, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 12, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 13, 1))
map.append(Door("Pictures/Tiles/Door_open_H.png", "Pictures/Tiles/Door_H.png", 8, 14, 1, False))
map.append(Wall("Pictures/Tiles/Wall.png", 9, 10))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 11, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 12, 1))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 13, 1))
...
map.append(Door("Pictures/Tiles/Door_open_V.png", "Pictures/Tiles/Door_V.png", 10, 12, 1, False))
...
map.append(Door("Pictures/Tiles/Door_open_H.png", "Pictures/Tiles/Door_H.png", 8, 19, 3, False))
...
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 20, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 20, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 20, 3))
map.append(Wall("Pictures/Tiles/Wall.png", 10, 20))
map.append(Wall("Pictures/Tiles/Wall.png", 6, 21))
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 21, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 21, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 21, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 10, 21, 3))
map.append(Wall("Pictures/Tiles/Wall.png", 6, 22))
map.append(Tile("Pictures/Tiles/Floor_1.png", 7, 22, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 8, 22, 3))
map.append(Tile("Pictures/Tiles/Floor_1.png", 9, 22, 3))
